...
% rate_spd = 2500/0.005; 
% 
% Kp_Cctrl_d = Ld/(6*0.707^2*Tpwm);
% Ki_Cctrl_d = Rs/(6*0.707^2*Tpwm);
% Kp_Cctrl_q = Lq/(6*0.707^2*Tpwm);
% Ki_Cctrl_q = Rs/(6*0.707^2*Tpwm);
...
% %%
% Kp_Spdctrl_3 = (4*J)/(50*P*flux*Tpwm);
% Ki_Spdctrl_3 = Kp_Spdctrl_3/tau_s;??
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% ADC signal process 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
SimMode =1;
